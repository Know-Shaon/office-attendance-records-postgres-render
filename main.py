...
def manager_home():
    try:
        ...
        logging.error("Error in manager_home: %s", e)
...
def member_home():
    try:
        ...
        logging.error("Error in member_home: %s", e)
        flash('An error occurred')
        return redirect(url_for('index'))
...
def create_team():
    try:
        ...
        logging.error("Error in create_team: %s", e)
        flash('An error occurred while creating the team')
        return redirect(url_for('index'))
...
def add_member():
    try:
        if 'team_id' in session and session.get('is_manager'):
            ...
            return render_template('add_member.html', team_id=session['team_id'], members=members)
        else:
            flash('Unauthorized access')
            return redirect(url_for('index'))
    except Exception as e:
        logging.error("Error in add_member: %s", e)
...
def remove_member():
    try:
        ...
        logging.error("Error in remove_member: %s", e)
        flash('An error occurred while removing the member')
        return redirect(url_for('index'))
...
def mark_attendance(team_id, member_name):
    try:
        ...
        logging.error("Error in mark_attendance: %s", e)
        flash('An error occurred while marking the attendance')
        return redirect(url_for('index'))
...
def export_data():
    try:
        ...
        logging.error("Error in export_data: %s", e)
        flash('An error occurred while exporting the data')
        return redirect(url_for('index'))
...
def track_attendance(team_id):
    try:
        ...
        logging.error("Error in track_attendance: %s", e)
        flash('An error occurred while tracking attendance')
        return redirect(url_for('index'))
...
def download_monthly_report(team_id):
    try:
        ...
        logging.error("Error in download_monthly_report: %s", e)
        flash('An error occurred while downloading the report')
        return redirect(url_for('index'))
...
def admin():
    try:
        ...
        logging.error("Error in admin: %s", e)
...
def remove_team():
    try:
        ...
        logging.error("Error in remove_team: %s", e)
        flash('An error occurred while removing the team')
        return redirect(url_for('admin'))
...
def get_members(team_id):
    try:
        ...
        logging.error("Error in get_members: %s", e)
        return jsonify({'error': 'An error occurred while fetching members'})
...
def update_excel(team_id, is_manager):
    try:
        ...
        logging.error("Error in update_excel: %s", e)
        raise
